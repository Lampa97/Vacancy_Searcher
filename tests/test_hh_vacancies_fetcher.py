...
def test_squeeze(vacancy_full_info):
    ...
    assert hh_fetcher.squeeze() == [{'name': 'Java Developer', 'salary': {'from': 50000, 'to': 80000, 'currency': 'RUR'}, 'url': 'https://hh.ru/vacancy/108174610', 'requirement': 'At least 2 years of practical experience with <highlighttext>Java</highlighttext> development. A strong understanding of Spring, Hibernate and OOP principles and...'}]
